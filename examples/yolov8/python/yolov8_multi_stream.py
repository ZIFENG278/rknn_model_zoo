...
class RKNNWorker:
    ...
    def infer(self, frame_bgr: np.ndarray):
        ...
        # RKNNLite runtime expects batched tensor for NPU input, use NHWC 4D.
        ...
        try:
            ...
            raise RuntimeError(
                f'[{self.worker_name}] inference failed, input shape={inp.shape}, '
                f'dtype={inp.dtype}. Check model input layout and preprocessing.'
            ) from exc
